...
describe("utils/ApiClient", () => {
    ...
    describe("doPutMultipart()", () => {
        ...
        //         drivers_license_front: "/Users/amylavarapu/Desktop/drivers_license_front.png",
        //         drivers_license_back: "/Users/amylavarapu/Desktop/drivers_licesnse_back.png",
        //     };
        //     nock("https://test-server")
        //         .matchHeader("Authorization", authHeader)
        //         .matchHeader("User-Agent", `Hyperwallet Node SDK v${packageJson.version}`)
        ...
        //                 }] }, { "Content-Type": "application/jose+json" });
        //
        //     client.doPutMultipart("test", data, { sort: "test" }, (err, body, res) => {
        //         expect(err).to.be.undefined();
        //
        //         body.should.be.deep.equal({
        //             response: "value",
        ...
        //         data: JSON.stringify(documents),
        //         drivers_license_front: "/Users/amylavarapu/Desktop/drivers_license_front.png",
        //         drivers_license_back: "/Users/amylavarapu/Desktop/drivers_license_back.png",
        //     };
        //
        //     nock("https://test-server")
        //         .matchHeader("Authorization", authHeader)
        ...
        //             data: "value",
        //         })
        //         .reply(200, { response: "value" }, { "Content-Type": "application/jose+json" });
        //
        //     client.doPutMultipart("test", data, {}, (err, body, res) => {
        //         err.should.be.deep.equal([{
        //             message: " ENOENT: no such file or directory, open '{values[1]}'",
        //             code: "COMMUNICATION_ERROR",
        //         }]);
        //
        //         expect(body).to.be.undefined();
        ...
        // /** @test {ApiClient#doPutMultipart} */
        // it("should return error when server responds with error on encrypted PUT request", (cb) => {
        //     const clientPath = path.join(__dirname, "..", "resources", "private-jwkset1");
        //     const hwPath = path.join(__dirname, "..", "resources", "public-jwkset1");
        //     const clientWithEncryption = new ApiClient("test-username", "test-password", "https://test-server", {
        //         clientPrivateKeySetPath: clientPath,
