...
describe('Hyperwallet', () => {
  ...
  describe('constructor()', () => {
    ...
    it('should initialize ApiClient with default server', () => {
      ...
      client.client.server.should.be.equal(
    ...
    it('should set programToken if provided', () => {
      ...
      expect(client.programToken).to.exist.and.equals('test-program-token');
    });
    ...
    it('should throw error if username and password is missing', () => {
      expect(() => new Hyperwallet(<any>{})).to.throw(
        'You need to specify your API username and password!'
      );
    });
  });
  ...
  describe('listUsers()', () => {
    it('should not have any TLS issues', cb => {
      const client: Hyperwallet = new Hyperwallet({
        username: 'test-username',
        password: 'test-password'
      });

      client.listUsers({}, async (err, body, res) => {
        await res.status.should.be.equal(401);
        cb();
      });
    });
  });
  ...
  describe('createUser()', () => {
    ...
    it('should do post call to users endpoint without programToken added', () => {
      ...
      apiClientSpy.should.have.been.calledWith(
        'users',
        {
          test: 'value'
        },
  ...
  describe('getUser()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() => client.getUser(undefined, callback)).to.throw(
  ...
  describe('updateUser()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.updateUser(undefined, { test: 'value' }, callback)
      ).to.throw('userToken is required');
    });
  ...
  describe('getUserStatusTransition()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getUserStatusTransition(undefined, undefined, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if statusTransitionToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getUserStatusTransition('test-user-token', undefined, callback)
      ).to.throw('statusTransitionToken is required');
    });
    ...
    it('should do get call if userToken and statusTransitionToken is provided', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/status-transitions/status-transition-token',
        {},
        callback
      );
    });
  ...
  describe('listUserStatusTransitions()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listUserStatusTransitions(undefined, {}, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should do get call with options', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/status-transitions',
        { test: 'value' }
      );
    });
  ...
  describe('createBankCard()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createBankCard(undefined, { test: 'value' }, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should do post call to bank cards endpoint', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/bank-cards',
        {
          test: 'value'
        },
        {},
  ...
  describe('getBankCard()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() => client.getBankCard(undefined, undefined, callback)).to.throw(
        'userToken is required'
      );
    });
    ...
    it('should throw error if bankCardToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getBankCard('test-user-token', undefined, callback)
      ).to.throw('bankCardToken is required');
    });
    ...
    it('should do get call if userToken and bankCardToken is provided', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/bank-cards/test-bank-card-token',
        {},
        callback
      );
    });
  ...
  describe('updateBankCard()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.updateBankCard(undefined, undefined, { test: 'value' }, callback)
      ).to.throw('userToken is required');
    });
  ...
  describe('listBankCards()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() => client.listBankCards(undefined, {}, callback)).to.throw(
        'userToken is required'
      );
    });
  ...
  describe('deactivate()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.deactivateBankCard(undefined, undefined, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if bankCardToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.deactivateBankCard('test-user-token', undefined, callback)
      ).to.throw('bankCardToken is required');
    });
    ...
    it("should send transition to 'DE_ACTIVATED'", () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/bank-cards/test-bank-card-token/status-transitions',
        {
  ...
  describe('createBankCardStatusTransition()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createBankCardStatusTransition(
          undefined,
          undefined,
          { test: 'value' },
          callback
  ...
  describe('getBankCardStatusTransition()', () => {
    ...
    it('should do get call if userToken, bankCardToken and statusTransitionToken is provided', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/bank-cards/test-bank-card-token/status-transitions/status-transition-token',
        {},
        callback
      );
    });
  ...
  describe('listBankCardStatusTransitions()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listBankCardStatusTransitions(undefined, undefined, {}, callback)
      ).to.throw('userToken is required');
    });
  ...
  describe('getAuthenticationToken()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() => client.getAuthenticationToken(undefined, callback)).to.throw(
        'userToken is required'
      );
    });
    ...
    it('should do post call to authentication token endpoint', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/authentication-token',
        {},
        {},
        callback
      );
  ...
  describe('createPaperCheck()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createPaperCheck(undefined, { test: 'value' }, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should do post call to paper checks endpoint', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/paper-checks',
        {
          test: 'value'
        },
        {},
  ...
  describe('getPaperCheck()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getPaperCheck(undefined, undefined, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if paperCheckToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getPaperCheck('test-user-token', undefined, callback)
      ).to.throw('paperCheckToken is required');
    });
    ...
    it('should do get call if userToken and paperCheckToken is provided', () => {
      ...
      client.getPaperCheck(
        'test-user-token',
        'test-paper-check-token',
        callback
      );

      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/paper-checks/test-paper-check-token',
        {},
        callback
      );
    });
  ...
  describe('listPaperChecks()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() => client.listPaperChecks(undefined, {}, callback)).to.throw(
        'userToken is required'
      );
    });
  ...
  describe('deactivate()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.deactivatePaperCheck(undefined, undefined, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if paperCheckToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.deactivatePaperCheck('test-user-token', undefined, callback)
      ).to.throw('paperCheckToken is required');
    });
    ...
    it("should send transition to 'DE_ACTIVATED'", () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/paper-checks/test-paper-check-token/status-transitions',
        {
          transition: 'DE_ACTIVATED'
        },
        {},
  ...
  describe('createPaperCheckStatusTransition()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createPaperCheckStatusTransition(
          undefined,
          undefined,
          { test: 'value' },
          callback
  ...
  describe('getPaperCheckStatusTransition()', () => {
    ...
    it('should do get call if userToken, paperCheckToken and statusTransitionToken is provided', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/paper-checks/test-paper-check-token/status-transitions/status-transition-token',
        {},
        callback
      );
    });
  ...
  describe('createTransfer()', () => {
    ...
    it('should throw error if sourceToken is missing', () => {
      ...
      ).to.throw('sourceToken is required');
    });
    ...
    it('should throw error if destinationToken is missing', () => {
      ...
      ).to.throw('destinationToken is required');
    });
    ...
    it('should throw error if clientTransferId is missing', () => {
      ...
      ).to.throw('clientTransferId is required');
    });
  ...
  describe('getTransfer()', () => {
    ...
    it('should throw error if transferToken is missing', () => {
      const callback = () => null;
      expect(() => client.getTransfer(undefined, callback)).to.throw(
        'transferToken is required'
      );
    });
  ...
  describe('createTransferStatusTransition()', () => {
    ...
    it('should throw error if transferToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createTransferStatusTransition(
          undefined,
          { test: 'value' },
          callback
        )
      ).to.throw('transferToken is required');
    });
    ...
    it('should send post call to transfer status transition endpoint', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'transfers/test-transfer-token/status-transitions',
        {
          test: 'value'
        },
        {},
  ...
  describe('createPayPalAccount()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createPayPalAccount(undefined, { test: 'value' }, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if transferMethodCountry is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createPayPalAccount(
          'test-user-token',
          { test: 'value' },
          callback
        )
      ).to.throw('transferMethodCountry is required');
    });
    ...
    it('should throw error if transferMethodCurrency is missing', () => {
      ...
      ).to.throw('transferMethodCurrency is required');
    });
    ...
    it('should do post call to PayPal account endpoint', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/paypal-accounts',
        {
          transferMethodCountry: 'test-transferMethodCountry',
          transferMethodCurrency: 'test-transferMethodCurrency',
          email: 'email'
  ...
  describe('getPayPalAccount()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getPayPalAccount(undefined, undefined, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if payPalAccountToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getPayPalAccount('test-user-token', undefined, callback)
      ).to.throw('payPalAccountToken is required');
    });
    ...
    it('should do get call if userToken and payPalAccountToken is provided', () => {
      ...
      client.getPayPalAccount(
        'test-user-token',
        'test-paypal-account-token',
        callback
      );

      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/paypal-accounts/test-paypal-account-token',
        {},
        callback
      );
    });
  ...
  describe('listPayPalAccounts()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() => client.listPayPalAccounts(undefined, {}, callback)).to.throw(
        'userToken is required'
      );
    });
  ...
  describe('createPrepaidCard()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createPrepaidCard(undefined, { test: 'value' }, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should do post call to prepaid cards endpoint', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/prepaid-cards',
        {
          test: 'value'
        },
        {},
  ...
  describe('getPrepaidCard()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getPrepaidCard(undefined, undefined, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if prepaidCardToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getPrepaidCard('test-user-token', undefined, callback)
      ).to.throw('prepaidCardToken is required');
    });
    ...
    it('should do get call if userToken and prepaidCardToken is provided', () => {
      ...
      client.getPrepaidCard(
        'test-user-token',
        'test-prepaid-card-token',
        callback
      );

      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/prepaid-cards/test-prepaid-card-token',
        {},
        callback
      );
    });
  ...
  describe('listPrepaidCards()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() => client.listPrepaidCards(undefined, {}, callback)).to.throw(
        'userToken is required'
      );
    });
  ...
  Object.keys(PREPAID_CARD_STATUS_CHANGE_METHODS).forEach(method => {
    ...
    describe(`${methodName}()`, () => {
      ...
      it('should throw error if userToken is missing', () => {
        const callback = () => null;
        expect(() =>
          client[methodName](undefined, undefined, callback)
        ).to.throw('userToken is required');
      });
      ...
      it('should throw error if prepaidCardToken is missing', () => {
        const callback = () => null;
        expect(() =>
          client[methodName]('test-user-token', undefined, callback)
        ).to.throw('prepaidCardToken is required');
      });
      ...
      it(`should send transition to '${PREPAID_CARD_STATUS_CHANGE_METHODS[method]}'`, () => {
        ...
        apiClientSpy.should.have.been.calledOnce();
        apiClientSpy.should.have.been.calledWith(
          'users/test-user-token/prepaid-cards/test-prepaid-card-token/status-transitions',
          {
  ...
  describe('createPrepaidCardStatusTransition()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createPrepaidCardStatusTransition(
          undefined,
          undefined,
          { test: 'value' },
          callback
  ...
  describe('getPrepaidCardStatusTransition()', () => {
    ...
    it('should do get call if userToken, prepaidCardToken and statusTransitionToken is provided', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/prepaid-cards/test-prepaid-card-token/status-transitions/status-transition-token',
        {},
        callback
      );
    });
  ...
  describe('createBankAccount()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createBankAccount(undefined, { test: 'value' }, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should do post call to bank accounts endpoint', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/bank-accounts',
        {
          test: 'value'
        },
        {},
  ...
  describe('getBankAccount()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getBankAccount(undefined, undefined, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if bankAccountToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getBankAccount('test-user-token', undefined, callback)
      ).to.throw('bankAccountToken is required');
    });
    ...
    it('should do get call if userToken and bankAccountToken is provided', () => {
      ...
      client.getBankAccount(
        'test-user-token',
        'test-bank-account-token',
        callback
      );

      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/bank-accounts/test-bank-account-token',
        {},
        callback
      );
    });
  ...
  describe('listBankAccounts()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() => client.listBankAccounts(undefined, {}, callback)).to.throw(
        'userToken is required'
      );
    });
  ...
  describe('deactivateBankAccount()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.deactivateBankAccount(undefined, undefined, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if bankAccountToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.deactivateBankAccount('test-user-token', undefined, callback)
      ).to.throw('bankAccountToken is required');
    });
    ...
    it("should send transition to 'DE-ACTIVATED'", () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/bank-accounts/test-bank-account-token/status-transitions',
        {
  ...
  describe('createBankAccountStatusTransition()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createBankAccountStatusTransition(
          undefined,
          undefined,
          { test: 'value' },
          callback
  ...
  describe('getBankAccountStatusTransition()', () => {
    ...
    it('should do get call if userToken, bankAccountToken and statusTransitionToken is provided', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/bank-accounts/test-bank-account-token/status-transitions/status-transition-token',
        {},
        callback
      );
    });
  ...
  describe('listBalancesForUser()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listBalancesForUser(undefined, {}, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should do get call with options', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/balances',
        { test: 'value' }
      );
    });
  ...
  describe('listBalancesForPrepaidCard()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listBalancesForPrepaidCard(undefined, undefined, {}, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should do get call with options', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/prepaid-cards/test-prepaid-card-token/balances',
        { test: 'value' }
      );
    });
  ...
  describe('listBalancesForAccount()', () => {
    ...
    it('should throw error if programToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listBalancesForAccount(undefined, undefined, {}, callback)
      ).to.throw('programToken is required');
    });
    ...
    it('should throw error if accountToken is missing', () => {
      ...
      ).to.throw('accountToken is required');
    });
    ...
    it('should do get call with options', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'programs/test-program-token/accounts/test-account-token/balances',
        { test: 'value' }
      );
    });
  ...
  describe('getPayment()', () => {
    ...
    it('should throw error if paymentToken is missing', () => {
      const callback = () => null;
      expect(() => client.getPayment(undefined, callback)).to.throw(
  ...
  describe('createPaymentStatusTransition()', () => {
    ...
    it('should throw error if paymentToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.createPaymentStatusTransition(
          undefined,
          { test: 'value' },
          callback
        )
      ).to.throw('paymentToken is required');
    });
    ...
    it('should send post call to payment status transition endpoint', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'payments/test-payment-token/status-transitions',
        {
          test: 'value'
        },
        {},
  ...
  describe('getPaymentStatusTransition()', () => {
    ...
    it('should throw error if paymentToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getPaymentStatusTransition(undefined, undefined, callback)
      ).to.throw('paymentToken is required');
    });
    ...
    it('should do get call if paymentToken and statusTransitionToken is provided', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'payments/test-payment-token/status-transitions/status-transition-token',
        {},
        callback
      );
    });
  ...
  describe('listPaymentStatusTransitions()', () => {
    ...
    it('should throw error if paymentToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listPaymentStatusTransitions(undefined, {}, callback)
      ).to.throw('paymentToken is required');
    });
  ...
  describe('getProgram()', () => {
    ...
    it('should throw error if programToken is missing', () => {
      const callback = () => null;
      expect(() => client.getProgram(undefined, callback)).to.throw(
        'programToken is required'
      );
    });
  ...
  describe('getProgramAccount()', () => {
    ...
    it('should throw error if programToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getProgramAccount(undefined, undefined, callback)
      ).to.throw('programToken is required');
    });
    ...
    it('should throw error if accountToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getProgramAccount('test-program-token', undefined, callback)
      ).to.throw('accountToken is required');
    });
    ...
    it('should do get call if programToken is provided', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'programs/test-program-token/accounts/test-account-token',
        {},
        callback
      );
    });
  ...
  describe('getTransferMethodConfiguration()', () => {
    ...
    it('should throw error if profileType is missing', () => {
      ...
      ).to.throw('profileType is required');
    });
  ...
  describe('listTransferMethodConfigurations()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listTransferMethodConfigurations(undefined, {}, callback)
      ).to.throw('userToken is required');
    });
  ...
  describe('createTransferMethod()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      ...
      expect(() =>
        client.createTransferMethod(userToken, cacheToken, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should throw error if cacheToken is missing', () => {
      ...
      expect(() =>
        client.createTransferMethod(userToken, cacheToken, callback)
      ).to.throw('jsonCacheToken is required');
    });
    ...
    it('should do post call with userToken and cacheToken', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/transfer-methods',
        { test: 'value' },
        { 'Json-Cache-Token': 'test-cache-token' }
      );
    });
  });
  ...
  describe('listReceiptsForProgramAccount()', () => {
    ...
    it('should throw error if programToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listReceiptsForProgramAccount(undefined, undefined, {}, callback)
      ).to.throw('programToken is required');
    });
    ...
    it('should do get call with options', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'programs/test-program-token/accounts/test-account-token/receipts',
        { test: 'value' }
      );
    });
  ...
  describe('listReceiptsForUser()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listReceiptsForUser(undefined, {}, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should do get call with options', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/receipts',
        { test: 'value' }
      );
    });
  ...
  describe('listReceiptsForPrepaidCard()', () => {
    ...
    it('should throw error if userToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.listReceiptsForPrepaidCard(undefined, undefined, {}, callback)
      ).to.throw('userToken is required');
    });
    ...
    it('should do get call with options', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'users/test-user-token/prepaid-cards/test-prepaid-card-token/receipts',
        { test: 'value' }
      );
    });
  ...
  describe('getWebhookNotification', () => {
    ...
    it('should throw error if webhookToken is missing', () => {
      const callback = () => null;
      expect(() =>
        client.getWebhookNotification(undefined, {}, callback)
      ).to.throw('webhookToken is required');
    });
    ...
    it('should do get call if webhookToken is provided', () => {
      ...
      apiClientSpy.should.have.been.calledOnce();
      apiClientSpy.should.have.been.calledWith(
        'webhook-notifications/webhook-token',
        {},
        callback
      );
    });
  ...
  describe('addProgramToken()', () => {
    it('should do nothing if no data is provided', () => {
      ...
      expect(client.addProgramToken(undefined)).to.be.undefined();
    });
    ...
    it('should do nothing if no programToken is set', () => {
      ...
      client
        .addProgramToken({ test: 'value' })
        .should.be.deep.equal({ test: 'value' });
    });
    ...
    it('should do nothing if programToken is set in data', () => {
      ...
      client
        .addProgramToken({ test: 'value', programToken: 'my-program-token' })
        .should.be.deep.equal({
          test: 'value',
          programToken: 'my-program-token'
        });
    });
    ...
    it('should add programToken if no programToken is set in data', () => {
      ...
      client.addProgramToken({ test: 'value' }).should.be.deep.equal({
        test: 'value',
        programToken: 'test-program-token'
      });
    });
  ...
  describe('handle204Response()', () => {
    ...
    it('should do nothing for non 204 responses', cb => {
      ...
      const callback = Hyperwallet.handle204Response((err, data, res) => {
        expect(err, 'error param should be undefined').to.be.undefined();
