...
describe("Hyperwallet", () => {
    ...
    describe("formatResForCallback()", () => {
        ...
        it("should return a formated response body, parse reasons", () => {
            ...
            const formattedRes = client.formatResForCallback(null, uploadRejectionData, null);
            expect(formattedRes.body.documents[0].type).to.equal(uploadRejectionData.documents[0].type);
            expect(formattedRes.body.documents[0].reasons[0].name).to.equal(uploadRejectionData.documents[0].reasons[0].name);
        });
